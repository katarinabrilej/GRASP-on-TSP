...
V projektni nalogi ugotovimo, da osnovni algoritem GRASP ne uporablja celotne zgodovine iskanja, potrebuje pa najboljšo že doseženo rešitev. 
Zaradi tega dobivajo druge metahevristike boljše rešitve, vendar pa je algoritem zaradi dvoje enostavnosti na splošno zelo hiter in je zmožen producirati kar dobre rezultate v kratkem času. 
Furthermore, it can besuccessfully integrated into other search techniques. %to še ttreba urediti
\pagebreak
